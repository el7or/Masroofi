...
namespace Puzzle.Masroofi.Core.Helpers
{
    public class Encryption
    {
        public static string EncryptData(string text, string hexKey)
        {
            ...
            string hexIV = "02b9d356f4a8c1ddc2159324914c5c7f"; //GenerateRandomHex(16);
            ...
            string hmacHexKey = "02b9d356f4a8c1ddc2159324914c5c7f"; //GenerateRandomHex(16);
            string hmacHexStr = __computeHMAC(hexIV, cipherHexStr, hexKey, hmacHexKey);

            string encryptedHexStr = hexIV + hmacHexKey + hmacHexStr + cipherHexStr;
            return encryptedHexStr.ToLower();
        }
        ...
        public static string DecryptData(string hexStr, string hexKey)
        {
            ...
            if (hexStr.Length > 128)
            {
                ...
                string computedHmacHexStr = __computeHMAC(hexIV, cipherHexStr, hexKey, hmacHexKey);
        ...
        private static string __computeHMAC(string hexIV, string cipherHexStr, string hexKey, string hmacHexKey)
        {
            ...
            byte[] hmacKey = Encoding.UTF8.GetBytes(hmacHexKey);
        ...
        private static string __encryptData(string hexString, string hexKey, string hexIV)
        {
