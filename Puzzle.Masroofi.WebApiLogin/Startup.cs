...
namespace Puzzle.Masroofi.WebApiLogin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Puzzle.Masroofi.WebApiLogin", Version = "v1" });
                ...
                var filePath = Path.Combine(AppContext.BaseDirectory, "Puzzle.Masroofi.WebApiLogin.xml");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Puzzle.Masroofi.WebApiLogin v1"));
