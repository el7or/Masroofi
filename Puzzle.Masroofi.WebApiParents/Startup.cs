...
namespace Puzzle.Masroofi.WebApiParents
{
    public class Startup
    {
        ...
        {
            services.AddAutoMapper(typeof(ParentProfile));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Puzzle.Masroofi.WebApiParents", Version = "v1" });
                ...
                var filePath = Path.Combine(AppContext.BaseDirectory, "Puzzle.Masroofi.WebApiParents.xml");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Puzzle.Masroofi.WebApiParents v1"));
