...
namespace Puzzle.Masroofi.WebApiAtmTransactions
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Puzzle.Masroofi.WebApiAtmTransactions", Version = "v1" });
                ...
                var filePath = Path.Combine(AppContext.BaseDirectory, "Puzzle.Masroofi.WebApiAtmTransactions.xml");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Puzzle.Masroofi.WebApiAtmTransactions v1"));
